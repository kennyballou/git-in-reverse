...
\usetheme{AnnArbor}
\usecolortheme[accent=blue]{modusoperandi}
...
\institute[CSUSM]{California State University San Marcos}
\date{Spring 2025}
...
% TikZ Styles
\tikzstyle{every node}=[%
    fill=modusoperandiBgMain,
    draw=modusoperandiFgMain,
    thick,
    rounded corners,
    anchor=north,
...
\begin{frame}
  ...
  \item<5->{Consider yourself a Git± expert}
  \end{itemize}
\end{frame}
...
\begin{frame}
  \note{%
   If that doesn't fix it, git.txt contains the phone number of a friend of
mine who understands git.  Just wait through a few minutes of ``It's really
...
\begin{itemize}
\item{Objects}
\item{Trees \(\gets\) objects}
\item{Commits \(\gets\) objects}
\end{itemize}
\end{frame}
...
\inputminted{bash}{code/1/1}
\end{frame}

\begin{frame}[fragile]
\frametitle{Initialization Results}
\inputminted{bash}{code/1/2}
\end{frame}
...
\inputminted{bash}{code/1/3}
\end{frame}

\begin{frame}[fragile]
\frametitle{\texttt{git-hash-object}}
\inputminted{bash}{code/1/4}
\end{frame}
...
\begin{figure}
\begin{tikzpicture}
    \node[text=modusoperandiBlue] at (0,  0) {257cc5642}
        child{node[text=modusoperandiGreen] {foo}};
    \node[text=modusoperandiBlue] at (3,  0) {5716ca598}
        child{node[text=modusoperandiGreen] {bar}};
\end{tikzpicture}
\end{figure}
\end{frame}
...
\inputminted{bash}{code/1/5}
\end{frame}

\begin{frame}[fragile]
\frametitle{Raw Access to Git Objects}
\inputminted{bash}{code/1/6}
\end{frame}
...
\begin{figure}
  \begin{tikzpicture}[sibling distance=3cm]
    \node[text=modusoperandiMagenta] at (0, 0) {fcf0be4d7}
        child{node[text=modusoperandiBlue] {257cc5642}
          child{node[text=modusoperandiGreen]{foo}}};
    \node[text=modusoperandiBlue] at (3, -1.75) {5716ca598}
        child{node[text=modusoperandiGreen]{bar}};
\end{tikzpicture}
\end{figure}
\end{frame}
...
\inputminted{bash}{code/2/3}
\end{frame}

\begin{frame}[fragile]
\frametitle{Git Objects}
\inputminted{bash}{code/2/4}
\end{frame}
...
\begin{figure}
\begin{tikzpicture}[sibling distance=3cm]
    \node[text=modusoperandiMagenta] at (0, 0) {b98c9a9f}
        child{node[text=modusoperandiBlue] (foo_hash) {257cc5642}
            child{node[text=modusoperandiGreen]{foo}}}
        child{node[text=modusoperandiBlue] {5716ca598}
            child{node[text=modusoperandiGreen] {bar}}};
    \node[text=modusoperandiMagenta] at (-3, 0) (previous_hash) {fcf0be4d7};
...
\begin{figure}
\begin{tikzpicture}[sibling distance=3cm]
    \node[text=modusoperandiMagenta] at (4, 0) {68b75754}
        child{node[text=modusoperandiBlue] (bar_hash) {5716ca598}
            child{node[text=modusoperandiGreen] {bar}}}
        child{node[text=modusoperandiBlue] {a3f555b64}
            child{node[text=modusoperandiGreen]{foo 2}}};
    \node[text=modusoperandiMagenta] at (0, 0) (previous_hash) {b98c9a9f}
        child{node[text=modusoperandiBlue] (foo_hash) {257cc5642}
            child{node[text=modusoperandiGreen]{foo}}};
...
\begin{tikzpicture}[sibling distance=3cm]
    \node at (0, 0) {Old Tree}
        child{node[text=modusoperandiMagenta] {b98c9a9f}
        child{node[text=modusoperandiBlue] {257cc5642}
            child{node[text=modusoperandiGreen]{foo}}}
        child{node[text=modusoperandiBlue] {5716ca598}
            child{node[text=modusoperandiGreen] {bar}}}};
    \node at (5, 0) {Current Tree}
        child{node[text=modusoperandiMagenta] {68b75754}
            child{node[text=modusoperandiBlue] {5716ca598}
                child{node[text=modusoperandiGreen] {bar}}}
            child{node[text=modusoperandiBlue] {a3f555b64}
                child{node[text=modusoperandiGreen]{foo 2}}}};
...
\begin{tikzpicture}[sibling distance=3cm]
    ...
    \node at (4, 0) {Current Tree}
        child{node[text=modusoperandiMagenta] (new_tree) {68b75754}
            child{node[text=modusoperandiBlue] {a3f555b64}
                child{node[text=modusoperandiGreen]{foo 2}}}};
...
\begin{figure}
\begin{tikzpicture}
    \node[text=modusoperandiCyan] {0e7ce0c}
        child{node[text=modusoperandiMagenta] {fcf0be4d7}
            child{node[text=modusoperandiBlue] {257cc5642}
                child{node[text=modusoperandiGreen]{foo}}}};
\end{tikzpicture}
\end{figure}
...
\begin{figure}
\begin{tikzpicture}[sibling distance=3cm]
    \node[text=modusoperandiCyan] {69ea0e9}
        child{node[text=modusoperandiCyan] {0e7ce0c}}
        child{node[text=modusoperandiMagenta] {b98c9a9f9}
            child{node[text=modusoperandiBlue] {5716ca598}
                child{node[text=modusoperandiGreen] {bar}}}
            child{node[text=modusoperandiBlue] {257cc5642}
                child{node[text=modusoperandiGreen]{foo}}}};
...
\begin{figure}
\begin{tikzpicture}[sibling distance=3cm]
    \node[text=modusoperandiCyan] {32a5f01}
        child{node[text=modusoperandiCyan] {69ea0e9}}
        child{node[text=modusoperandiMagenta] {68b757546}
            child{node[text=modusoperandiBlue] {5716ca598}
                child{node[text=modusoperandiGreen] {bar}}}
            child{node[text=modusoperandiBlue] {a3f555b64}
                child{node[text=modusoperandiGreen]{foo 2}}}};
...
\begin{figure}
\begin{tikzpicture}
    \node[text=modusoperandiBlue] (foo) at (10, -10) {foo};
\end{tikzpicture}
\end{figure}
\end{frame}
...
\begin{tikzpicture}
    \node[text=modusoperandiBlue] (foo) at (10, -10) {foo};
    \node[text=modusoperandiBlue] (hfoo) at (10, -8) {257cc564};
...
\begin{tikzpicture}
    \node[text=modusoperandiBlue] (foo) at (10, -10) {foo};
    \node[text=modusoperandiBlue] (hfoo) at (10, -8) {257cc564};
    \node[text=modusoperandiMagenta] (tree1) at (9, -6) {fcf0be4d};
    \draw[-o,thick] (hfoo) -- (foo);
...
\begin{tikzpicture}
    ...
    \node[text=modusoperandiBlue] (hfoo) at (10, -8) {257cc564};
    \node[text=modusoperandiMagenta] (tree1) at (9, -6) {fcf0be4d};
    \node[text=modusoperandiCyan] (commit1) at (5, -6) {0e7ce0c};
    \draw[-o,thick] (hfoo) -- (foo);
    \draw[-o,thick] (tree1) -- (hfoo);
...
\begin{figure}
\begin{tikzpicture}
    \node[dashed,text=modusoperandiBlue] (foo) at (10, -10) {foo};
    \node[text=modusoperandiBlue] (bar) at (8,  -10) {bar};
    \node[dashed,text=modusoperandiBlue] (hfoo) at (10, -8) {257cc564};
    \node[text=modusoperandiBlue] (hbar) at (8,  -8) {5716ca59};
    \node[text=modusoperandiMagenta] (tree1) at (9, -6) {fcf0be4d};
    \node[text=modusoperandiCyan] (commit1) at (5, -6) {0e7ce0c};
    \draw[-o,thick] (hfoo) -- (foo);
...
\begin{tikzpicture}
    ...
    \node[dashed,text=modusoperandiBlue] (hfoo) at (10, -8) {257cc564};
    \node[text=modusoperandiBlue] (hbar) at (8,  -8) {5716ca59};
    \node[text=modusoperandiMagenta] (tree2) at (9, -6) {b98c9a9f9};
    \node[text=modusoperandiCyan] (commit2) at (5, -6) {69ea0e9};
    \node[text=modusoperandiCyan] (commit1) at (5, -8) {0e7ce0c};
    \draw[-o,thick] (hfoo) -- (foo);
    \draw[-o,thick] (hbar) -- (bar);
...
\begin{figure}
\begin{tikzpicture}
    \node[text=modusoperandiBlue] (foo) at (10, -10) {foo 2};
    \node[dashed,text=modusoperandiBlue] (bar) at (8,  -10) {bar};
    \node[text=modusoperandiBlue] (hfoo) at (10, -8) {a3f555b6};
    \node[dashed,text=modusoperandiBlue] (hbar) at (8,  -8) {5716ca59};
    \node[text=modusoperandiMagenta] (tree3) at (9, -6) {68b75754};
    \node[text=modusoperandiCyan] (commit3) at (5, -6) {32a5f01};
    \node[text=modusoperandiCyan] (commit2) at (5, -8) {69ea0e9};
    \node[text=modusoperandiCyan] (commit1) at (5, -10) {0e7ce0c};
    \draw[-o,thick] (hfoo) -- (foo);
    \draw[-o,thick] (hbar) -- (bar);
    \draw[-o,thick] (tree2) -- (hfoo);
    \draw[-o,thick] (tree2) -- (hbar);
...
\inputminted[fontsize=\scriptsize{}]{bash}{code/packfiles/1}
\end{frame}

\begin{frame}[fragile]
\frametitle{Creating Packfiles}
\framesubtitle{\texttt{git-pack-objects}}
\inputminted{bash}{code/packfiles/2}
\end{frame}

\begin{frame}[fragile]
\frametitle{Creating Packfiles}
\framesubtitle{\texttt{git-gc}}
\inputminted{bash}{code/packfiles/3}
\end{frame}
...
\begin{frame}[fragile]
\frametitle{\texttt{git-init}}
\inputminted[fontsize=\scriptsize{}]{bash}{code/4/git-init}
\end{frame}
...
\texttt{git-checkout}:
\inputminted{bash}{code/5/3}
\end{frame}

\begin{frame}[fragile]
\frametitle{\texttt{git-checkout -b}}
Or, we can do all in the same command:
\inputminted{bash}{code/5/4}
\end{frame}

\begin{frame}[fragile]
\frametitle{Git± Branches}
Currently, all branches are pointing to the same commit:
\inputminted{bash}{code/5/5}
\end{frame}

\begin{frame}[fragile]
\frametitle{Git± Branches}
\inputminted{bash}{code/5/6}
\end{frame}

\begin{frame}[fragile]
\frametitle{Git± Branches}
\inputminted{bash}{code/5/7}
\end{frame}
...
\node (C2) at (0, 1.5) {C2};
\node (C3) at (1, 0) {C3};
\node[text=modusoperandiCyan] (trunk) at (-3, 1.5) {trunk};
\node[text=modusoperandiCyan] (develop) at (3, 0) {develop};

\draw[-o,thick] (C0) -- (C1);
\draw[-o,thick] (C1) -- (C2);
\draw[-o,thick] (C2) to[out=-90,in=90] (C3);
\draw[-o,thick] (trunk) -- (C2);
...
\node (C2) at (0, 1.5) {C2};
\node (C3) at (0, 0) {C3};
\node[text=modusoperandiCyan] (trunk) at (-3, 0) {trunk};
\node[text=modusoperandiCyan] (develop) at (3, 0) {develop};

\draw[-o,thick] (C0) -- (C1);
\draw[-o,thick] (C1) -- (C2);
\draw[-o,thick] (C2) -- (C3);
\draw[-o,thick] (trunk) -- (C3);
\draw[-o,thick] (develop) -- (C3);
...
\node (C1) at (0, 5) {C1};
\node (C2) at (0, 3) {C2};
\node[text=modusoperandiMagenta] (C2') at (1, 3) {C2};
\node[text=modusoperandiMagenta] (C3) at (1, 2) {C3};
...
\node[text=modusoperandiMagenta] (C2') at (1, 3) {C2};
\node[text=modusoperandiMagenta] (C3) at (1, 2) {C3};
\node[text=modusoperandiRed] (M1) at (0, 0) {M1};
...
\node (C2) at (5, 0) {C2};
\node (ours) at (5, 1) {ours};
\node[text=modusoperandiMagenta] (U1) at (3.5, -1) {U1};
\node[text=modusoperandiMagenta] (U2) at (5.5, -1) {U2};
\node[text=modusoperandiMagenta] (theirs) at (5.5, -2) {theirs};
...
\node[text=modusoperandiMagenta] (U1) at (3, 0) {U1};
\node[text=modusoperandiMagenta] (U2) at (5, 0) {U2};
\node[text=modusoperandiMagenta] (theirs) at (5, -1) {theirs};
...
\coordinate (root) at (0, -0.27);
\node (C0) at (1, 0) {C0};
\node[text=modusoperandiRed] (C1) at (7, 0) {C1'};
\node[text=modusoperandiRed] (C2) at (9, 0) {C2'};
\node (U1) at (3, 0) {U1};
\node (U2) at (5, 0) {U2};
...
\begin{frame}
  \note{%
    \begin{itemize}
      \item{Merge branch 'asdfasjkfdlas/alkdjf' into sdkjfls-final}
    \end{itemize}
  }
...
\inputminted{vctreestatus}{code/gitlog}
\end{frame}
...
\end{itemize}
\inputminted[label=\texttt{\~{}/.gitconfig}]{linuxconfig}{code/5/9}
\end{frame}
...
\item<5->{\texttt{\#{}git} on \href{https://libre.chat}{Libre.Chat}}
